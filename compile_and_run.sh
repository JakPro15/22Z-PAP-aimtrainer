...
$mysql --host=localhost --socket="$HOME/pap22Z_z03_mysql/mysqld.sock" -u root <Scripts/setup_user.sql
$mysql --host=localhost --socket="$HOME/pap22Z_z03_mysql/mysqld.sock" -u pap22Z_z03 -ppap.2022.PAP <Scripts/setup_database.sql
